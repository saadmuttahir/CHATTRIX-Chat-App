  ...
  return (
    ...
    <div className="flex min-h-screen flex-col justify-center px-6 py-12 lg:px-8 bg-black backdrop-blur-lg">
      <div className=" mx-auto  ">
        ...
        />
        <h2 className=" mt-3 text-center text-2xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-tr from-violet-500 to-pink-500">Login your account</h2>
      </div>
